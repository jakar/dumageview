...
{
  DialogRunner::DialogRunner(QDialog* dialog_, QObject* parent_,
                             bool ownDialog)
  :
    QObject{parent_},
    _dialog{dialog_},
    _deleteDialogWhenFinished{ownDialog}
  {
    DUMAGEVIEW_ASSERT(_dialog);
    qtutil::connect(_dialog, &QDialog::destroyed,
                    this, &DialogRunner::cleanup);
  }
  ...
  {
    qtutil::connect(_dialog, &QDialog::finished,
                    this, &DialogRunner::unwindHandlers);
  }
